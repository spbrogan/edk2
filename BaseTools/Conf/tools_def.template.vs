...
# 1.23 - Set /GS- for all to avoid stack cookies in Tianocore Edk2.  TODO: get this into Edk2
...
#
DEFINE _VSCOMMON_CC_FLAGS        = /nologo /X /c /WX /W4 /Gs32768 /D UNICODE /O1b2 /Oi- /MP /GL /FIAutoGen.h /EHs-c- /GR- /GF /Gy /Zi /Zo /Gw /GS-
...
*_VS2017_IA32_ASM_PATH     = DEF(VS2017_BIN_IA32)\ml.exe
  ...
  DEBUG_VS2017_IA32_CC_FLAGS    = DEF(DEBUG_VSCOMMON_CC_FLAGS) /arch:IA32
RELEASE_VS2017_IA32_CC_FLAGS    = DEF(RELEASE_VSCOMMON_CC_FLAGS) /arch:IA32
NOOPT_VS2017_IA32_CC_FLAGS      = DEF(NOOPT_VSCOMMON_CC_FLAGS) /arch:IA32
...
RELEASE_VS2017_X64_CC_FLAGS    = DEF(RELEASE_VSCOMMON_CC_FLAGS)
NOOPT_VS2017_X64_CC_FLAGS      = DEF(NOOPT_VSCOMMON_CC_FLAGS)
...
*_VS2017_AARCH64_ASLDLINK_PATH     = DEF(VS2017_BIN_AARCH64)\link.exe
  ...
  DEBUG_VS2017_AARCH64_CC_FLAGS    = DEF(DEBUG_VSCOMMON_CC_FLAGS) /wd4214 /wd4127 /wd4100 /wd4312 /wd4702
RELEASE_VS2017_AARCH64_CC_FLAGS    = DEF(RELEASE_VSCOMMON_CC_FLAGS) /wd4214 /wd4127 /wd4100 /wd4312 /wd4702
NOOPT_VS2017_AARCH64_CC_FLAGS      = DEF(NOOPT_VSCOMMON_CC_FLAGS) /wd4702
...
*_VS2019_IA32_ASM_PATH     = DEF(VS2019_BIN_IA32)\ml.exe
  ...
  DEBUG_VS2019_IA32_CC_FLAGS    = DEF(DEBUG_VSCOMMON_CC_FLAGS) /arch:IA32
RELEASE_VS2019_IA32_CC_FLAGS    = DEF(RELEASE_VSCOMMON_CC_FLAGS) /arch:IA32
NOOPT_VS2019_IA32_CC_FLAGS      = DEF(NOOPT_VSCOMMON_CC_FLAGS) /arch:IA32
...
RELEASE_VS2019_X64_CC_FLAGS    = DEF(RELEASE_VSCOMMON_CC_FLAGS)
NOOPT_VS2019_X64_CC_FLAGS      = DEF(NOOPT_VSCOMMON_CC_FLAGS)
...
*_VS2019_AARCH64_ASLDLINK_PATH     = DEF(VS2019_BIN_AARCH64)\link.exe
  ...
  DEBUG_VS2019_AARCH64_CC_FLAGS    = DEF(DEBUG_VSCOMMON_CC_FLAGS) /wd4214 /wd4127 /wd4100 /wd4312 /wd4702
RELEASE_VS2019_AARCH64_CC_FLAGS    = DEF(RELEASE_VSCOMMON_CC_FLAGS) /wd4214 /wd4127 /wd4100 /wd4312 /wd4702
NOOPT_VS2019_AARCH64_CC_FLAGS      = DEF(NOOPT_VSCOMMON_CC_FLAGS) /wd4702
